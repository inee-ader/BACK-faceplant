...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { user_id: @like.user_id, user_plant_id: @like.user_plant_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { user_id: @like.user_id, user_plant_id: @like.user_plant_id } }
